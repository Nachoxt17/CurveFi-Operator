...
interface ICurveFiCurveYContractInterface extends ethers.utils.Interface {
  functions: {
    "A()": FunctionFragment;
...
export class ICurveFiCurveYContract extends BaseContract {
  ...
  interface: ICurveFiCurveYContractInterface;
