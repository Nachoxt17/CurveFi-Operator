...
interface BPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "isexternalSwap()": FunctionFragment;
    ...
    "setexternalSwap(bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "isexternalSwap",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class BPool extends BaseContract {
  ...
  functions: {
    ...
    isexternalSwap(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    isexternalSwap(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    isexternalSwap(overrides?: CallOverrides): Promise<PopulatedTransaction>;
