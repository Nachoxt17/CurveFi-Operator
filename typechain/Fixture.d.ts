...
interface FixtureInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "vm_std_cheats",
    values?: undefined
  ): string;
...
export class Fixture extends BaseContract {
  ...
  functions: {
    ...
    vm_std_cheats(overrides?: CallOverrides): Promise<[string]>;
  };
  ...
  callStatic: {
    ...
    testTokenOK(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    vm_std_cheats(overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    vm_std_cheats(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
